...
* Easy activation through Wordpress plugin: it is necessary to have a Lead Champion discover license. Try the [demo](https://www.leadchampion.com/lpdiscover) to discover the service and you will be contacted by our customer service.
...
* Easy activation through Wordpress plugin: it is necessary to have a Lead Champion booster license. Try the [demo](https://www.leadchampion.com/lp-boosterdesktop)  to discover the service and you will be contacted by our customer service.
...
1. Lead Champion plugin configuration
...
* Compatibility with plugin 1.x

= 22.5.12 =
* Compatibility WP 6.0
* Introduction of Lead Champion COOKIELESS configuration
...
= 1.2.1 =
* WP Italian and English internationalization

= 1.2 =
* Italian and English internationalization
